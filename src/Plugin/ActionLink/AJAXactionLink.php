...
use Drupal\flag\Plugin\ActionLink\AJAXactionLink as OriginalAJAXactionLink;
 ...
 *
 * @ActionLinkType(
 *   id = "ui_patterns_ajax_link",
 *   label = @Translation("AJAX link (with UI Patterns)"),
 *   description = "An AJAX JavaScript request will be made without reloading the page."
 * )
 */
class AJAXactionLink extends OriginalAJAXactionLink {
